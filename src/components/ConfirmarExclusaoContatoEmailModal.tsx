...
interface ConfirmarExclusaoContatoEmailModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  nomeContato: string;
...
export default function ConfirmarExclusaoContatoEmailModal({
  isOpen,
  onClose,
  onConfirm,
  nomeContato,
  emailContato,
  excluindo = false,
}: ConfirmarExclusaoContatoEmailModalProps) {
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700">
        ...
        <div className="p-6">
          <p className="text-slate-700 dark:text-slate-300 mb-4">
            Você tem certeza que deseja remover este contato email?
          </p>
          <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-3 mb-4">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-1 mt-2">
              Email:
            </p>
            <p className="font-semibold text-slate-900 dark:text-white">
              {emailContato}
