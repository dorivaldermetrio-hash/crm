...
/**
 * Schema para uma mensagem única do Instagram DM (subdocumento)
 * Não é um modelo separado, será usado como subdocumento em MensagemDM
 */
export const MensagemUnicaDMSchema = new Schema(
  {
    mensagemInstagramId: {
      type: String,
      required: true,
...
export interface IMensagemUnicaDM {
  mensagemInstagramId: string;
  mensagem: string;
  dataHora: Date;
  tipo: string;
  contatoID?: string;
